...
namespace Domowik___WebAPI.Services
{
    ...
    public class AccountService : IAccountService
    {
        ...
        public AccountService(DomowikDbContext context, IPasswordHasher<User> passwordHasher, AuthenticationSettings authenticationSettings)
        {
            _context = context;
        ...
        public string GenerateJwt(LoginDto dto)
        {
            ...
            if (user == null)
            {
                throw new BadRequestException("Niepoprawny adres email lub hasło");
            }
