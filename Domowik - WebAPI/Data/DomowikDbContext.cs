...
namespace Domowik___WebAPI.Data
{
    ...
    {
        private string _connectionString = "Data Source=DESKTOP-UGC60U0\\SQLEXPRESS;Initial Catalog=DomowikDb;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False";
